'''
output : Click on any object in the video , based on the object clicked it will fetch the color
of perticular object and apply the contour over it.
'''
...
cap=cv2.VideoCapture('../Images and Videos/ball2.mp4')
cv2.namedWindow('tb')
